...
insert into products (name, description, color, soort, code, price) values ('Cherry Mondkapje', 'Een mooie dieprode kersen kleur.', '', '', '123989705-7', 10.5);
insert into products (name, description, color, soort, code, price) values ('Mondkapje wit met rode stippen', 'Op een grote paddenstoel, wit met rode stippen. Ehh... ik bedoel rood met witte stippen! ', '', '', '158335316-X', 13);
insert into products (name, description, color, soort, code, price) values ('Mondkapje met rode ruitjes', 'Rode ruitjes met blauwe lijnen.', '', '', '406911007-0', 12);
insert into products (name, description, color, soort, code, price) values ('Plastic Mondkapje', 'Hetzelfde als een normaal mondkapje, maar dan van een speciaal soort plastic.', '', '', '547253543-3', 14);
insert into products (name, description, color, soort, code, price) values ('Kerst Mondkapje', 'Groen en rood patroon.', '', '', '690994502-6', 10.5);
insert into products (name, description, color, soort, code, price) values ('Coochie Monster Mondkapje', 'Een monster dat eet en blauw is.', '', '', '676124066-2', 12.5);
insert into products (name, description, color, soort, code, price) values ('Suede Mondkapje (Blauw)', 'Een mooie, exquisite, suede mondkapje in het blauw', '', '', '457174385-8', 14);
insert into products (name, description, color, soort, code, price) values ('Suede Mondkapje (Rood)', 'Een mooie, exquisite, suede mondkapje in het rood', '', '', '031445258-3', 13.5);
insert into products (name, description, color, soort, code, price) values ('Suede Mondkapje (Groen)', 'Een mooie, exquisite, suede mondkapje in het groen', '', '', '719322921-4', 12.5);
insert into products (name, description, color, soort, code, price) values ('Zwart Mondkapje met glitters', 'Glitters! Glitters! En nog meer glitters!', '', '', '514202783-3', 14.5);
insert into products (name, description, color, soort, code, price) values ('Grijs Mondkapje', 'Grijs.', '', '', '185213824-6', 14.5);
insert into products (name, description, color, soort, code, price) values ('Animegirl Mondkapje', 'Anime is een Japanse cartoon.', '', '', '229696258-0', 11.5);
